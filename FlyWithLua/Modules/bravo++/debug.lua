...
local function hex(b) return string.format("%02X", b or 0) end

function M.enable(v) enabled = v end
...
function M.log_report_diff(r, last)
  ...
  if not last then
    M.log_report(r); last_report = r; return
  end
  local diffs = {}
