...
local last_selector_time = -1
local last_trim_time = -1
...
function M.reset()
    handlers = {}
    last_report = nil
    counters = { selector_changes = 0, rotary_events = 0, trim_events = 0 }
    last_rotary_time = -1
    last_selector_time = -1
    last_trim_time = -1
    last_rotary_dir = nil
    last_seen_rotary_byte = nil
    last_seen_selector_byte = nil
