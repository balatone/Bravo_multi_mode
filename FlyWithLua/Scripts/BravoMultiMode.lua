...
function build_bravo_gui(wnd, x, y)
    ...
    imgui.PushStyleColor(imgui.constant.Col.WindowBg, 0xFF181818) -- Light Grey
    ...
    for i = 1, #modes do
        ...
        if current_mode == modes[i] then
            ...
            text_color = 0xFF3A3A3A -- Dark Grey (AABBGGRR)
        end
    ...
    for i = 1, #switch_map_labels do
        ...
        local switch_label_color =  0xFFFFFF00
        if led_state == true then
            switch_label_color = 0xFFFFFFFF
        elseif led_state == false then
            switch_label_color = 0xFF3A3A3A
        end
    ...
    imgui.NewLine() -- Start a new line after selection label for buttons
    local h_offset_io = 475
    local y_offset_io = 0
    local y_spacing_io = 40
    local io_width = 60
    ...
    for i = 1, #outer_inner_modes do
        ...
        if current_cf_mode == outer_inner_modes[i] then
            ...
            text_color = 0xFF333333 -- Dark Grey (AABBGGRR)
        end
